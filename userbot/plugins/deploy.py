...
DEFAULTUSER = str(AUTONAME) if AUTONAME else "WHITE-DEVIL-V2"
...
async def _(event):
   ...
   # input_str = event.pattern_match.group(1)
    ...
    animation_chars = [
            ...
            "**Heroku Connecting To Latest Github Build (Theshashankk/WHITE-DEVIL-V2)**",
            ...
            "__INFO:TEAMWHITE:Logged in as 557667062__",
